...
public class Shop {
    public static void main(String[] args) {
        ...
        ProductInfo.calculateAmount(productInfo1); // вызов метода, который считает общую сумму со скидкой и без у объекта product1

        System.out.println();

        System.out.println(productInfo2);
        ProductInfo.calculateAmount(productInfo2); // вызов метода, который считает общую сумму со скидкой и без у объекта product2

        System.out.println();

        System.out.println(productInfo3);
        ProductInfo.calculateAmount(productInfo3); // вызов метода, который считает общую сумму со скидкой и без у объекта product3
    }
}
